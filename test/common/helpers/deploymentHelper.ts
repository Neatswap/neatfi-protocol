...
export const deployAssetSwapV1 = async (
  ...
  const assetSwapV1Factory = await ethers.getContractFactory('AssetSwapV1') as AssetSwapV1Factory;
...
export const deployPaymentsResolverOperationsV1 = async (
  ...
  const paymentResolverOperationsV1Factory = await ethers.getContractFactory('PaymentsResolverOperationsV1') as PaymentsResolverOperationsV1Factory;
...
export const deployProtocolSettingsV1 = async (): Promise<ProtocolSettingsV1> => {
...
export const deployNeatFiProtocolTreasuryV1 = async (): Promise<NeatFiProtocolTreasuryV1> => {
...
export const deployNeatswapImplementationV1 = async (
  ...
  const neatSwapImplementationV1Factory = await ethers.getContractFactory('NeatSwapImplementationV1') as NeatSwapImplementationV1Factory;
