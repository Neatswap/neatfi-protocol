...
export interface IAssetSwapInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "approveAndResolveSwap" | "makeBid"
  ): FunctionFragment;
...
export interface IAssetSwap extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAssetSwapInterface;
