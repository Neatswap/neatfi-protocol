...
export interface PaymentsResolverOperationsUpgradeableInterface
...
export interface PaymentsResolverOperationsUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PaymentsResolverOperationsUpgradeableInterface;
