...
export interface AssetEventsUpgradeableInterface extends utils.Interface {
  functions: {};
...
export interface AssetEventsUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetEventsUpgradeableInterface;
