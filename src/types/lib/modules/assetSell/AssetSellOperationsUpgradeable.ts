...
export interface AssetSellOperationsUpgradeableInterface
...
export interface AssetSellOperationsUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetSellOperationsUpgradeableInterface;
